...
# Мини игры (Сделать вторую и третью мини игру) -- Для бета теста достаточно
...
# Мой сталкер (сделано, скины и фоны пока заглушки, помощь в группе неплохо бы дописать) -- помощь набросать
...
# Аукцион (сделано, нельзя продавать нестакающиеся итемы) -- достаточно
...
# Арена (сделано) -- для беты достаточно
...
# Ссылки (не сделано) -- Для бета теста не нужны
KEYBOARD_SOURCE = [13, '✉ Беседа для активных сталкеров', '📈 Торговля между игроками']
# -----------------------------------------------------------------------------------

# Донат (не сделано) -- Для бета теста не нужны
...
KEYBOARD_LAST_ID = 56  # Када делаеш новую клаву добавляй +1 -- нужна просто чтобы не сбиться со счёта
